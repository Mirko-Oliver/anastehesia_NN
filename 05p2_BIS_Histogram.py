...
def main():
	...
	plt.bar(x, counts_regular, label="Regulär")
	plt.bar(x, counts_invalid, bottom=counts_regular, label="Ungültig")
	plt.bar(x, counts_irregular, bottom=counts_regular + counts_invalid, label="Irregulär")

	plt.title("BIS Verteilung über alle Fälle")
	plt.xlabel("BIS")
	plt.ylabel("Anzahl")
	plt.xlim(-0.5, 100.5)
